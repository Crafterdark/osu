...
{
    public class CatchModHalfTime : ModHalfTime, IApplicableToBeatmapProcessor, IApplicableToDrawableRuleset<CatchHitObject>
    {
        [SettingSource("Do not change catcher speed", "The catcher is not affected by speed decrease.")]
