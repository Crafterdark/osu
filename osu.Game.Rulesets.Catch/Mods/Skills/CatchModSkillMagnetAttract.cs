...
{
    public class CatchModSkillMagnetAttract : Mod, IApplicableToDrawableRuleset<CatchHitObject>, IUpdatableByPlayfield, IApplicableToBeatmap
    {
        public override string Name => "Magnet Attract Skill";
        public override string Acronym => "MA";
        public override LocalisableString Description => "The fruits will be attracted by the catcher for a limited amount of time.";
