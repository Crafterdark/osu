...
{
    public class CatchModSkillBulletTime : Mod, IApplicableToDrawableRuleset<CatchHitObject>, IUpdatableByPlayfield, IApplicableToBeatmap
    {
        public override string Name => "Bullet Time Skill";
        public override string Acronym => "BT";
        public override LocalisableString Description => "The song will be extremely slow for a limited amount of time.";
