...
namespace osu.Game.Rulesets.Catch.UI
{
    ...
    public partial class Catcher : SkinReloadableDrawable
    {
        ...
        public bool CanCatch(CatchHitObject hitObject)
        {
            ...
            {
                var syncFrame = (CatchReplayFrame?)replayState.Frames?.Find(x => x.Time >= (int)hitObject.StartTime && (((CatchReplayFrame)x).RecordHandler == FrameRecordHandler.Judgement || ((CatchReplayFrame)x).RecordHandler == FrameRecordHandler.LegacyUpdateJudgement));
