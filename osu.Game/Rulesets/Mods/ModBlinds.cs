...
{
    public partial class ModBlinds : Mod, IUpdatableByPlayfield, IApplicableToScoreProcessor, IApplicableToHealthProcessor
    {
        ...
        {
            if (!BlindsFullOpaque.Value && Blinds != null)
                Blinds.Alpha = (float)Interpolation.Lerp(Blinds.Alpha, ComboBasedAlpha, Math.Clamp(playfield.Time.Elapsed / TRANSITION_DURATION, 0, 1));
        }
